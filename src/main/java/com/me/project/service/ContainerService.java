...
import com.me.project.api.DockerCommand;

import com.me.project.api.*;
	...
	public void create(String image, String name, String cmd, String ports) {
	   ...
	   public InspectContainerResponse info(String id) {
	    ...
	    public void stop(String id) {
	        ...
	        if (cli == null)
	            return;
	        System.out.println("Here I am in stop container service");
	    ...
	    public void delete(String id) {
	        ...
	        if (cli == null)
	            return;
	        System.out.println("Here I am in delete container service");
	    ...
	    public void pause(String id) {
	        ...
	        if (cli == null)
	            return;
	        System.out.println("Here I am in pause container service");
	    ...
	    public void unPause(String id) {
	        ...
	        if (cli == null)
	            return;
	        System.out.println("Here I am in unpause container service");
	    ...
	    public void commit(String id) {
	        ...
	        if (cli == null)
	            return;
	        System.out.println("Here I am in commit container service");
	        cli.commitCmd(id).exec();
	    }

	    public void kill(String id) {
	    	System.out.println("Here I am in kill container service");
	        DockerClient cli = docker.getDockerClient();
	        if (cli == null)
	            return;
	        System.out.println("Here I am in kill container service");
	    ...
	    public void containerStart(String id) {
	        ...
	        if (cli == null)
	            return;
	        System.out.println("Here I am in start container service");
	    ...
	    public void restart(String id) {
	        ...
	        if (cli == null)
	            return;
	        System.out.println("Here I am in restart container service");
	    ...
	    public String log(String id) throws IOException {
	        ...
	        BufferedReader reader = new BufferedReader(new InputStreamReader(cli
	                ...
	                .exec(), "utf-8")); // bugfix: add stream to
	                                                       // cmd
